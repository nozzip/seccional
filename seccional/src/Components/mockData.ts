...
export const dataCaruselSection1: DataItem[] = [
  { id: 1, title: 'Noticia 1', thumbnail: '', short_description: 'Descripción corta 1' },
  { id: 2, title: 'Noticia 2', thumbnail: '', short_description: 'Descripción corta 2' },
];
...
export const dataServicios: DataItem[] = [
  ...
  { id: 3, title: 'SALON SAN LORENZO', thumbnail: 'https://i.imgur.com/uECOaEP.png', short_description: 'Salta' },
];
...
export const dataNoticias: Noticia[] = [
  {
    ...
    short_description: 'Resumen de la noticia 1',
