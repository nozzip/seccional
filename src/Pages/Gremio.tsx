...
const authorities = [
  {
    name: "GARCIA SALADO KUHL, RAMIRO",
  ...
  {
    name: "GALLARDO, RAMON ERNESTO",
    role: "SECRETARIO ADMINISTRATIVO",
    level: 3,
  },
  {
    name: "BATALLAN CORTEZ, MARTA DEL R.",
    role: "SECRETARIO DE ORGANIZACIÓN",
    level: 3,
  },
  {
    name: "FRAGA, JORGE HORACIO",
    role: "SECRETARIA DE PRENSA Y ACTAS",
    level: 3,
  },
  {
    name: "CARLOS, GONZALO DAMIAN",
  ...
  {
    name: "BUSTAMANTE, ORLANDO RAMON",
    role: "PRIMERA VOCAL SUPLENTE",
    level: 4,
  },
  {
    name: "ISA TORANZOS, JAQUELINE SILVANA",
    role: "SEGUNDO VOCAL SUPLENTE",
    level: 4,
  },
  { name: "BAZAN, CARLOS JAVIER", role: "TERCERA VOCAL SUPLENTE", level: 4 },
  {
    name: "MERCADO, GRISELDA DEL TRANSITO",
    role: "DELEG. TIT. COMISIÓN NAC. DE JUBILADOS",
    level: 4,
  },
  {
    name: "CELEDÓN, MIGUEL ÁNGEL",
    role: "DELEG. TIT. COMISIÓN NAC. DE JUBILADOS",
    level: 4,
  },
  {
    name: "NAVARRO, MARÍA MARTA",
    role: "DELEG. SUPL. COMISIÓN NAC. DE JUBILADOS",
    level: 4,
  },
  {
    name: "LITOVIC, JUAN JOSÉ",
    role: "DELEG. SUPL. COMISIÓN NAC. DE JUBILADOS",
    level: 4,
  },
  {
    name: "CALIZAYA, LEBED GASTÓN",
    role: "CONGRESAL TITULAR A LA F.E.F.R.A.",
    level: 4,
  },
  {
    name: "MERCADO, JOSÉ ANTONIO",
    role: "CONGRESAL TITULAR A LA F.E.F.R.A.",
    level: 4,
  },
  {
    name: "MIRANDA, CYNTIA BETIANA",
    role: "CONGRESAL SUPLENTE A LA F.E.F.R.A.",
    level: 4,
  },
  {
    name: "BULACIO ÁLVAREZ, LUCIANA",
    role: "CONGRESAL SUPLENTE A LA F.E.F.R.A.",
    level: 4,
  },
];
      ...
      {person.image && (
        <CardMedia
          ...
          sx={{
            ...
            objectFit:
              person.role === "SECRETARIO GENERAL" ? "contain" : "cover",
            bgcolor:
              person.role === "SECRETARIO GENERAL"
  ...
  return (
    <Box sx={{ pt: { xs: 12, md: 16 }, pb: 10, bgcolor: "background.default" }}>
      <Helmet>
        ...
        <meta
          name="description"
          content="Conoce a las autoridades y representantes gremiales de nuestra seccional."
        />
      </Helmet>
      <Container maxWidth="lg">
        ...
        >
          Conocé a los representantes de nuestra seccional comprometidos con la
