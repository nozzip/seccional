...
import CashRegistry from '../../Components/Admin/CashRegistry';
        ...
        <Box sx={{ pt: { xs: 12, md: 16 }, pb: 10, bgcolor: 'background.default', minHeight: '100vh' }}>
            ...
            <Container maxWidth="xl">
                ...
                >
                    ...
                    >
                        <Tab icon={<DashboardIcon />} label="Resumen" iconPosition="start" />
                        <Tab icon={<PeopleIcon />} label="Alumnos" iconPosition="start" />
                        <Tab icon={<AccountBalanceWalletIcon />} label="Finanzas" iconPosition="start" />
                        <Tab icon={<PointOfSaleIcon />} label="Arqueo" iconPosition="start" />
                        <Tab icon={<InventoryIcon />} label="Inventario" iconPosition="start" />
                    ...
                    <Box sx={{ p: { xs: 2, md: 4 } }}>
                        ...
                        {activeTab === 1 && <StudentManager />}
                        {activeTab === 2 && <CashFlowManager />}
                        {activeTab === 3 && <CashRegistry />}
                        {activeTab === 4 && <InventoryManager />}
                        {activeTab === 5 && <PoolSchoolGrid />}
                        {activeTab === 6 && <CourtBookingGrid />}
                        {activeTab === 7 && <PoolManager />}
                    </Box>
                </Paper>
            </Container>
        </Box>
