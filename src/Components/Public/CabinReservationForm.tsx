...
export default function CabinReservationForm({ open, onClose, initialType = 'confort4' }: Props) {
    ...
    const handleSubmit = async () => {
        if (!formData.nombre || !formData.telefono || !formData.start_date || !formData.end_date) {
                ...
                <DialogContent sx={{ textAlign: 'center', py: 6 }}>
                    <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Hemos recibido su pedido de reserva. Nos pondremos en contacto pronto para confirmar disponibilidad y procesar la seña.
                        </Typography>
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            <DialogTitle sx={{ fontWeight: 900, display: 'flex', alignItems: 'center', gap: 1 }}>
                <CalendarMonthIcon color="primary" /> Solicitar Reserva en El Mollar
            </DialogTitle>
